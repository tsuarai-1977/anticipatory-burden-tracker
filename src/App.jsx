...
const STATUS = { pending: "⏳ 未着手", touched: "🔰 一部着手", in_progress: "🔄 着手中", paused: "⏸️ 中断", completed: "✅ 完了" };
const STATUS_COLORS = { pending: "#E8637A", touched: "#F5A623", in_progress: "#6BB5E8", paused: "#999", completed: "#7ED6A0" };
